...
| [fe04cdb-test-evermemos-rs--add-unit-tests-for-memory-metabolism-and-user-profile-updates.md](./fe04cdb-test-evermemos-rs--add-unit-tests-for-memory-metabolism-and-user-profile-updates.md) | 记忆新陈代谢单元测试：为 `UserProfileRepo` 和 `ProfileExtractor` 添加了完整的单元测试，验证了跨对话的 Profile 合并与冲突解决逻辑，并修复了一个影响文档测试的 ASCII 字符编码问题。 |
